<?php 
    ...
    $res_barang = mysqli_query($koneksi,"SELECT * FROM barang_keluar WHERE id = $id");
...
<body>
    ...
    <a href="./">Kembali</a>
    <form action="./aksi/edit_barang_keluar.php" method="post">
        ...
        <div>
            ...
            <input type="text" name="pengambil" id="pengambil" value="<?=$data_old['pengambil']?>" placeholder="Masukkan Pengambil Barang">
        </div>
        <div>
