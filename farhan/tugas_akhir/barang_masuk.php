    ...
    <div class="card">
                                ...
                                <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'Admin') {?>
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="./form_barang_masuk.php?id=<?=$d['id']?>" class="btn btn-warning">Edit</a>
                                            <a href="javascript:void(0)" class="btn btn-danger btn-delete-link" data-link="./aksi/hapus_barang_masuk.php?id=<?=$d['id']?>" onclick="deleteAlert(this)">Hapus</a>
                                        </div>
                                    </td>
                                <?php }?>
                            </tr>
        ...
        <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'Admin') {?>
            <div class="card-footer d-flex justify-content-center">
                <a href="./form_barang_masuk.php" class="btn btn-primary">Tambah Data</a>
            </div>
        <?php }?>
    </div>
</div>
